class GBIEngine:
    ...
    def validate_inputs(self, target_amount, current_savings, monthly_deposit, years, inflation_rate):
        """
        보안 및 금융 논리 취약점 방어
        """
        if target_amount <= 0:
        ...
        # inflation_rate 검증 추가: 하이퍼인플레이션이나 비정상 입력 방어
    ...
    def run_simulation(self, 
        ...
        error = self.validate_inputs(target_amount, current_savings, monthly_deposit, years, inflation_rate)
        if error:
